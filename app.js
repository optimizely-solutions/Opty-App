          ...
          data: JSON.stringify({
            "body": {
              messageSegments: [{
                ...
                type: "text",
                "text": this.ChatterMessage + ' Notification By ' + this.currentUser().name() + ". If you need further information, please follow up with " + this.currentUser().name() + " directly. You can view the customer's Zendesk ticket by clicking the link below."
              }, {
                type: "link",
